...
public class CrashHandlerUtils implements UncaughtExceptionHandler {
    ...
    // crash 文件地址
    public static final String CRASH_FILE = Environment.getExternalStorageDirectory().getPath() + "/android/com.yt.bleandnfc/crash_log/";
    ...
    private void dumpExceptionToSDCard(Throwable ex) throws IOException {
        ...
        File file = new File(CRASH_FILE + FILE_NAME + time + FILE_NAME_SUFFIX);
