package com.example.ytdemo.view;
...
public class CommonTitleBarView extends LinearLayout {
    ...
    private void initStyle(Context context, AttributeSet attrs){
        ...
        // 进行赋值操作
        // 背景
        if (title_bg_res!=null && title_bg_res != getContext().getDrawable(R.drawable.ic_home_black_24dp)) {
            mBgTv.setBackground(title_bg_res);
        } else {
            mBgTv.setBackgroundColor(Color.parseColor("#000000"));
        }
        ...
        if (left_iv_res != null && left_iv_res != getContext().getDrawable(R.drawable.ic_home_black_24dp)) {
            mLeftIv.setImageDrawable(left_iv_res);
        } else {
            mLeftIv.setImageResource(R.drawable.ic_home_black_24dp);
        }
        ...
        if (right_iv_res != null && right_iv_res != getContext().getDrawable(R.drawable.ic_home_black_24dp)) {
            mRightIv.setImageDrawable(right_iv_res);
        } else {
            mRightIv.setImageResource(R.drawable.ic_home_black_24dp);
        }
