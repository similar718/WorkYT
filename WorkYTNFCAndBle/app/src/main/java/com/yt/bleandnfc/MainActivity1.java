...
public class MainActivity1 extends YTBaseActivity<MainViewModel1, ActivityMain1Binding> {
    ...
    @Override
    protected MainViewModel1 createViewModel() {
        viewModel = new MainViewModel1();
    ...
    protected void initData() {
        ...
        dataBinding.tvConnect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!mBleName.isEmpty()){
                    com.clj.fastble.config.Constants.mBleName = mBleName;
                }
    ...
    private void StartConnectListener(){
        if (BLEAndGPSUtils.isOpenGPS(YTApplication.getInstance())) {
        ...
        public void handleMessage(@NonNull Message msg) {
            ...
            switch (msg.what){
                case HANDLER_INIT_IMAGEVIEW:
                    mIsOpenGPS = BLEAndGPSUtils.isOpenGPS(YTApplication.getInstance());
...
//                    }
    ...
    private void initBlueTooth() {
        BleNFCManager.getInstance().initBleNFC(getApplication(),MainActivity1.this,mListener); // TODO
...
//        }
    ...
    private NfcView mNFCView = new NfcView() {
        ...
        public void appendResponse(final String response) {
            ...
            Vibrator vibrator = (Vibrator) MainActivity1.this.getSystemService(MainActivity1.this.VIBRATOR_SERVICE);
            vibrator.vibrate(1000); // 获取成功只有震动1秒的钟
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    ToastUtils.showText(MainActivity1.this,response);
