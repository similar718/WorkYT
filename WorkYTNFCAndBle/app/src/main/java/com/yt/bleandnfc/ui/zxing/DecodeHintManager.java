  ...
  static Map<DecodeHintType,?> parseDecodeHints(Uri inputUri) {
    ...
    for (DecodeHintType hintType: DecodeHintType.values()) {
      ...
      /*if (hintType.getValueType().equals(Object.class)) {
        ...
        // Can we make a different assumption on this?
      ...
      /*if (hintType.getValueType().equals(int[].class)) {
        ...
        for (int i = 0; i < values.length; i++) {
          try {
            ...
            LogUtils.w(TAG, "Skipping array of integers hint " + hintType + " due to invalid numeric value");
            array = null;
            break;
          }
        }
      ...
      if (extras.containsKey(hintName)) {
        /*if (hintType.getValueType().equals(Void.class)) {
          ...
          if (hintType.getValueType().isInstance(hintData)) {
            ...
            LogUtils.w(TAG, "Ignoring hint " + hintType + " because it is not a " + hintType.getValueType());
          }
        }*/
      }
    }
