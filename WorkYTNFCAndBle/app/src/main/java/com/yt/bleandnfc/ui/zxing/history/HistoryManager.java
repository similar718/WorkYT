...
package com.yt.bleandnfc.ui.zxing.history;
...
import com.yt.bleandnfc.ui.zxing.result.ResultHandler;
...
public final class HistoryManager {
  ...
  public void trimHistory() {
    ...
    try (SQLiteDatabase db = helper.getWritableDatabase();
      ...
      while (cursor.moveToNext()) {
        ...
        LogUtlis.i(TAG, "Deleting scan history ID " + id);
  ...
  static Uri saveHistory(String history) {
    ...
    if (!historyRoot.mkdirs() && !historyRoot.isDirectory()) {
      LogUtlis.w(TAG, "Couldn't make dir " + historyRoot);
      return null;
    }
    ...
    try (OutputStreamWriter out = new OutputStreamWriter(new FileOutputStream(historyFile), StandardCharsets.UTF_8)) {
      ...
      LogUtlis.w(TAG, "Couldn't access file " + historyFile + " due to " + ioe);
      return null;
    }
  }
