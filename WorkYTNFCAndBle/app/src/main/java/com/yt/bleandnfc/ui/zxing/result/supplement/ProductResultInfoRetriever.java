...
package com.yt.bleandnfc.ui.zxing.result.supplement;
...
import com.yt.bleandnfc.ui.zxing.HttpHelper;
...
//  private final Context context;
  ...
  ProductResultInfoRetriever(TextView textView, String productID, HistoryManager historyManager, Context context) {
    ...
    this.source = context.getApplicationContext().getString(R.string.msg_google_product);
//    this.context = context.getApplicationContext();
  ...
  void retrieveSupplementalInfo() throws IOException {
    ...
    String uri = "https://www.google." + LocaleManager.getProductSearchCountryTLD(contextWeakReference.get())
