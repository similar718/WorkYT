...
package com.yt.bleandnfc.ui.zxing.share;
...
//  private final ListActivity activity;
  WeakReference<ListActivity> activityWeakReference;
...
//    this.activity = activity;
  ...
  protected void onPostExecute(final List<AppInfo> results) {
    ListAdapter listAdapter = new ArrayAdapter<AppInfo>(activityWeakReference.get(),
    ...
    activityWeakReference.get().setListAdapter(listAdapter);
  }
